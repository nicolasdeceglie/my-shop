...
export function CartPage() {
    ...
    return (
        <div>
            ...
            <ul>
                {list.map(p => (
                    <li key={p.product.id} className="flex flex-col sm:flex-row items-center gap-3 justify-between my-3 border-b border-blue-400 py-3 ">
            ...
            {
                !isEmpty && <div className="flex justify-center">
